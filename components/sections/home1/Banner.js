  ...
  useEffect(() => {
    ...
    return (
        ...
        backgroundImage: isMobile
          ...
          : "url(assets/images/resources/naslovnaaa.jpg)",
        ...
        backgroundRepeat: "no-repeat",
                    ...
                    <SwiperSlide>
                        <div className="swiper-slide">
                            <div className="image-layer slikaaaaaaa" style={{ backgroundImage: "url(assets/images/resources/Mirav-2036_compressed.webp)"}}></div>
                            <div className="image-layer__left-gradient"></div>
                            <div className="container">
                                <div className="row">
                                    <div className="col-xl-12">
